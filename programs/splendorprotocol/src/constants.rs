...
pub const VAULT_TOKENA_SEED: &str = "vault-tokena-seed";
pub const VAULT_TOKENB_SEED: &str = "vault-tokenb-seed";
pub const VAULT_TOKENTUA_SEED: &str = "vault-tutokena-seed";
pub const VAULT_TOKENTUB_SEED: &str = "vault-tutokenb-seed";
